          ...
          {nextThreeEvents.length === 0 ? (
            <Card className="bg-gradient-to-br from-gray-50 to-gray-100">
              <CardContent className="text-center py-8">
                ...
                <p className="text-muted-foreground font-medium">Nenhum evento próximo</p>
                <p className="text-sm text-muted-foreground mt-1">Adicione eventos para acompanhar suas atividades</p>
                <Button
                  variant="outline"
                  size="sm"
                  className="mt-4"
