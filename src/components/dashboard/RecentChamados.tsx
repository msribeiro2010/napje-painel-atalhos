              ...
              >
                <CardContent className="p-4">
                  <div className="space-y-3">
                    <h3 className="font-medium text-sm line-clamp-2">{chamado.titulo}</h3>
                    ...
                    <div className="flex items-center justify-center gap-1 pt-2 border-t">
                      <Button
                        ...
                        className="h-7 w-7 p-0 text-purple-600 border-purple-600 hover:bg-purple-50"
                        title="Duplicar"
                      >
                      ...
                      <Button
                        ...
                        className="h-7 w-7 p-0 text-green-600 border-green-600 hover:bg-green-50"
                        title="Editar"
                      >
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button
                            ...
                            className="h-7 w-7 p-0 text-red-600 border-red-600 hover:bg-red-50"
                            title="Excluir"
                          >
